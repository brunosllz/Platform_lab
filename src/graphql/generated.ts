...
export type GetSlugLessonsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetSlugLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', slug: string, id: string }> };
...
export const GetSlugLessonsDocument = gql`
    query GetSlugLessons {
  lessons(orderBy: id_ASC) {
    slug
    id
  }
...
/**
 * __useGetSlugLessonsQuery__
 *
 * To run a query within a React component, call `useGetSlugLessonsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetSlugLessonsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetSlugLessonsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetSlugLessonsQuery(baseOptions?: Apollo.QueryHookOptions<GetSlugLessonsQuery, GetSlugLessonsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetSlugLessonsQuery, GetSlugLessonsQueryVariables>(GetSlugLessonsDocument, options);
      }
export function useGetSlugLessonsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetSlugLessonsQuery, GetSlugLessonsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetSlugLessonsQuery, GetSlugLessonsQueryVariables>(GetSlugLessonsDocument, options);
        }
export type GetSlugLessonsQueryHookResult = ReturnType<typeof useGetSlugLessonsQuery>;
export type GetSlugLessonsLazyQueryHookResult = ReturnType<typeof useGetSlugLessonsLazyQuery>;
export type GetSlugLessonsQueryResult = Apollo.QueryResult<GetSlugLessonsQuery, GetSlugLessonsQueryVariables>;